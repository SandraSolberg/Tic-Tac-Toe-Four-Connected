...
s	 * Initializes a JFrame in which we place the game
	 ...
	 * @param exampleParam 
	 */
	private void reset(String exampleParam) {
	...
	private void updateMessage(String exampleParam) {
		statusMessage.setText(exampleParam);
	}
	...
	private JPanel createButtonPanel() {
		...
		exampleButton2.setText("button 1");

		exampleButton1 = new JButton();
		exampleButton1.addActionListener(this);
		exampleButton1.setText("button 2");

		statusMessage = new JLabel();
		statusMessage.setText("Welcome to this game!, choose a game ");
